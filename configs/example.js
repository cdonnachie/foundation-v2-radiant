...
ports1.tls = false;
ports1.difficulty = {};
ports1.difficulty.initial = 6;
ports1.difficulty.minimum = 6;
...
// Coin Configuration
config.primary.coin = {};
config.primary.coin.name = 'Radiant';
config.primary.coin.symbol = 'RXD';
config.primary.coin.algorithm = 'sha512256d';
